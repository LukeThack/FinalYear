...
def show_image(key,ship,band,file_name,ais_df):
    ...
    while category not in ["0","1"]:
        category=input("Enter category for ship (0-Ship, 1-Background Noise): \n")
    ...
    if acceptable:
        cv2.imwrite("SHIP_CATEGORISATION_IMAGES/dataset2/images/"+file_name, img_3_channel)
...
dark_ships,found_confirmed_ships,multi_ships=find_dark_ships("202306",'satelite/image12.dim',250,50)
